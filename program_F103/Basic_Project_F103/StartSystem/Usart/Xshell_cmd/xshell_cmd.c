...
u8 do_cmd(u8 *str)
{
	if (strcmp((char *)str, "iic_dection") == 0)
		test_i2c("0");
	else if (strcmp((char *)str, "help") == 0)
		work_help("0");
	else if (strstr((char *)str, "ls") != 0)
		work_help("0");
	else if (strcmp((char *)str, "reset") == 0)
		reset_system("0");
	else if (strstr((char *)str, "buzzer") != 0)
		buzzer(str);
	else
